...
to distribute-cars ;; procedure
 ...
 if (heading = 0) [setxy 6 (38 + random (max-pycor - 38)) * (2 * random 2 - 1)]
 if (heading = 90) [setxy ((38 + random (max-pxcor - 38)) * (2 * random 2 - 1)) -6]
 if (heading = 180) [setxy -6 ((38 + random (max-pycor - 38)) * (2 * random 2 - 1))]
 if (heading = 270) [setxy ((38 + random (max-pxcor - 38)) * (2 * random 2 - 1)) 6]
 if any? other turtles-here [distribute-cars ]
end
...
to goroundabout
 ...
 ifelse droundabout > 0 [
   ...
   let cars-ahead cars-inroundabout with [(subtract-headings heading myhd > -90) and (subtract-headings heading myhd < 0)]
